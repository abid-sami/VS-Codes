...
public:
    void adata(string na, float b, int n)
    {
        name = na;
        bal = b;
        no = n;
...
public:
    void cdata(string na, float b, int n, float mb, float c)
    {
        adata(na, b, n);
        minbal = mb;
        charge = c;
...
public:
    void sdata(string na, float b, int n, float i)
    {
        adata(na, b, n);
        interest = i;
    }
...
int main()
{
    ...
    cur_acct c;
    c.cdata("Ragib", 500, 789456, 300, 50);
    c.display();
    c.withdraw(200);
    c.display();
}
