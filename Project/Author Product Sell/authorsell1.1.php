...
add_shortcode('author_product_dashboard', function () {
    ...
    if (isset($_GET['add_new_product']) || isset($_GET['edit_product'])) {
        ...
        echo '<input type="text" name="product_name" value="' . esc_attr($name) . '" placeholder="Product Name" required>';
        echo '<input type="number" step="0.01" min="0" name="product_price" value="' . esc_attr(get_post_meta($edit_id, '_price', true)) . '" placeholder="Product Price" required>';
        echo '<textarea name="product_details" placeholder="Product Details" required>' . esc_textarea($desc) . '</textarea>';
        echo '<select name="product_category" required>';
        ...
        echo '<input type="text" name="seller_name" value="' . esc_attr(get_post_meta($edit_id, '_seller_name', true)) . '" placeholder="Your Nick-name" required>';       
        echo '<input type="text" name="contact_number" value="' . esc_attr($contact) . '" placeholder="Contact Number">';
        echo '<input type="text" name="semester_number" value="' . esc_attr($semester) . '" placeholder="Semester Number">';
        echo '<input type="url" name="facebook_id" value="' . esc_attr($facebook) . '" placeholder="Facebook Profile Link">';
        echo '<select name="varsity_name" required>';
